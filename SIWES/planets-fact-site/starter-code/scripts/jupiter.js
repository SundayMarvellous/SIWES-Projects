document.addEventListener("DOMContentLoaded", function () {
    ...
    const defaultImageSrc = "./assets/planet-jupiter.svg"; // Set the default image source
    ...
    internalStructureButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/planet-jupiter-internal.svg"; // Set internal structure image
    });
    ...
    surfaceGeologyButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/surface-geology-jupiter.svg"; // Set surface geology image
    });
  });
