document.addEventListener("DOMContentLoaded", function () {
    ...
    const defaultImageSrc = "./assets/planet-earth.svg"; // Set the default image source
    ...
    internalStructureButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/planet-earth-internal.svg"; // Set internal structure image
    });
    ...
    surfaceGeologyButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/surface-geology-earth.svg"; // Set surface geology image
    });
  });
