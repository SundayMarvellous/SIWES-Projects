document.addEventListener("DOMContentLoaded", function () {
    ...
    const defaultImageSrc = "./assets/planet-uranus.svg"; // Set the default image source
    ...
    internalStructureButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/planet-uranus-internal.svg"; // Set internal structure image
    });
    ...
    surfaceGeologyButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/surface-geology-uranus.svg"; // Set surface geology image
    });
  });
