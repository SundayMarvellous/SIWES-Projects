document.addEventListener("DOMContentLoaded", function () {
    ...
    const defaultImageSrc = "./assets/planet-venus.svg"; // Set the default image source
    ...
    internalStructureButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/planet-venus-internal.svg"; // Set internal structure image
    });
