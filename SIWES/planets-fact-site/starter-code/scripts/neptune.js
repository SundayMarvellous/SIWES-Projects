document.addEventListener("DOMContentLoaded", function () {
    ...
    const defaultImageSrc = "./assets/planet-neptune.svg"; // Set the default image source
    ...
    internalStructureButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/planet-neptune-internal.svg"; // Set internal structure image
    });
    ...
    surfaceGeologyButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/surface-geology-neptune.svg"; // Set surface geology image
    });
  });
