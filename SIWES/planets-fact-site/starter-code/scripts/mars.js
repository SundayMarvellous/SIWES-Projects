document.addEventListener("DOMContentLoaded", function () {
    ...
    const defaultImageSrc = "./assets/planet-mars.svg"; // Set the default image source
    ...
    internalStructureButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/planet-mars-internal.svg"; // Set internal structure image
    });
    ...
    surfaceGeologyButton.addEventListener("click", function () {
      ...
      planetImage.src = "./assets/surface-geology-mars.svg"; // Set surface geology image
    });
  });
